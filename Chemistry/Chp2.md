...
![Metallic Bonds - Electron Sea](https://cdn1.byjus.com/wp-content/uploads/2018/07/Metallic-Bonds-2-700x369.png)

- *Metalic bond result from the **electrostatic attractive forces** between **positively charged metal** and mobile/**free electrons***
- The metallic bond is **stronger** when there're **more delocalized electrons**
  ...
  - e.g. metallic bond of aluminium is stronger than the metallic bond of potassium
...
2. conduct **electricity**
   - The movement of mobile/delocalized electrons through the metal lattice conducts electricity
...
- The presence of the other atoms (smaller or bigger) disrupts the symmerty of the layers and reduces the ability of one layer to slide over another, results in a stronger, harder and less malleable metal.
- Other atoms, whether smaller or larger, disrupt the layers' symmetry and lessen the ability of one layer to slide over another. produces a metal that is harder, stronger, and less malleable.
...
2. hard but brittle易碎的
   - ![Ionic crytal cracks](https://i.ibb.co/k5SYPSb/2-ionic-crystal-cracks.jpg)
...
3. **conduct electricity** when **molten** or **dissolved in water** (not when solid)
...
Practice: NaCl, MgCl~2~, K~2~O, CaO, Al~2~O~3~, CaF, Na~2~O, KF, MgF~2~

###  Covalent Bonding

![NaCl](https://i.ibb.co/MPCLNFz/2-nacl-dot-and-cross.jpg)

- Covalent bond: the electrostatic attractive force between the nuclei of adjacent atoms and share electron pairs
  - *electrostatic forces*: strong forces of attraction between particles with opposite charges

#### Lewis Structures

Practice: H~2~, Cl~2~, HCl, H~2~O
...
*Examples of the above table, with image better

*Lewis Structures

Practice: CH~4~, CCl~4~, SO~2~, H~2~S, PCl~3~, NH~3~, CO~2~, NCl~3~, OF~2~, SF~2~, CS~2~, Cl~2~O, F~2~, CH~3~Cl, Cl~2~O, NF~3~, SiCl~4~, SiO~2~, CO, O~3~
